...
@foreach ($books as $b )
      ...
      <a href="/product/book/detail/{{$b->title}}" class=" flex flex-col items-center bg-white border overflow-hidden border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            ...
            <div class="flex flex-col  justify-between p-4 leading-normal">
                <h5 class="mb-2 sm:text-2xl text-base font-bold tracking-tight text-gray-900 dark:text-white">{{$b->title}}</h5>
               ...
               <div class="flex item-center">
                ...
                <p class="ms-2 sm:text-sm text-xs font-bold text-gray-900 dark:text-white">{{number_format($b->comments->avg('rating'),1)}}</p>
    <span class="w-1 h-1 mx-1.5 bg-gray-500 rounded-full dark:bg-gray-400"></span>
    <p class="text-xs sm:text-sm font-medium text-gray-900 underline hover:no-underline dark:text-white"> {{$b->comments->count()}} reviews</p>

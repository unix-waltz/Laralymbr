    ...
    <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <form action="/user/contact" method="post" class="space-y-8">
            ...
            <div>
                ...
                <input type="text" name="name" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" placeholder="{{Auth()->user()->fullname}}" value="{{Auth()->user()->fullname}}"  required>
            </div>
            <div class="grid grid-cols-2 gap-5">
                <span>
                <label for="subject" class="block mb-2 text-sm font-medium text-gray-900 ">Subject</label>
                <input type="text"  value="I want to report '{{$data}}'." id="subject" name="subject" class="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500" placeholder="Let us know how we can help you/I want to ......" required>
            </span>
<span class="">

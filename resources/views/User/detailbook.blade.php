...
<div class="w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 ">
    ...
    <div class="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
        <form action="/contact/{{$title->title}}" method="post" class="w-full sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5">
           @csrf
        ...
        @if ($title->status == 'canqueued')
        <form action="/user/borrow" method="post" class="w-full sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5">
          @csrf
          @method('POST')
    ...
    <article class="p-6 text-base bg-white rounded-lg ">
          ...
          <footer class="flex justify-between items-center mb-2">
            ...
            <div id="dropdownComment{{$c->id}}"
                class="hidden z-10 w-36 bg-white rounded divide-y divide-gray-100 shadow d ">
                  <ul class="py-1 text-sm text-gray-700  "
                      ...
                      @else
                        <li>
                          <form action="/contact/{{'@'.$c->userComents->username}}" method="post" class="w-full sm:w-auto bg-white focus:ring-4 focus:outline-none focus:ring-gray-300 rounded-lg inline-flex items-center justify-center px-4 py-2.5  d ">
                            @csrf

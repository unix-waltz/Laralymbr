...
<div id="default-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
  ...
  <div class="row-span-3 bg-white shadow rounded-lg">
        ...
        <div class="overflow-y-auto" style="max-height: 24rem;">
          <ul class="p-6 space-y-6">
            @foreach ($_books_borrowed as $c )
              <li class="flex items-center">
         <h1>-</h1>
              <a href="/admin/book/detail/{{$c->book->id}}" class="text-gray-600 font-semibold">{{$c->book->title}}<span style="" class="font-normal">&nbsp;by {{$c->user->username}}</span></a>
              <span class="ml-auto font-semibold">
    ...
    <section class="">
      <div class="grid grid-cols-2 lg:grid-cols-3 mx-auto mt-11 gap-3  ">
        @foreach ($books as $b )
        
              <a href="/admin/book/detail/{{$b->id}}" class=" flex flex-col items-center bg-white border overflow-hidden border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 ">

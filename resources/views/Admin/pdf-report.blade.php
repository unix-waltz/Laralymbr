...
<div class="w-[90%] mx-auto mt-10">
    ...
    <h1 class="mb-4 text-xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl"><mark class="px-2 text-white bg-blue-600 rounded  ">{{$by}}</mark> &nbsp;PDF Report.</h1>
